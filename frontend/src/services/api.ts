...
export const studentApi = {
    ...
    // verifyEmail: (id: string) => api.post(`/students/${id}/verify-email`),
...
export const instructorApi = {
    ...
    // verifyEmail: (id: string) => api.post(`/instructors/${id}/verify-email`),
...
export const adminApi = {
    ...
    // verifyEmail: (id: string) => api.post(`/admins/${id}/verify-email`),
